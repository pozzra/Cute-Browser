              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Row(
                    ...
                    children: [
                      const SizedBox(width: 12),
                      const Icon(Icons.search_rounded, color: CuteColors.lightText, size: 20),
                      if (browserProvider.currentUrl != "about:blank") ...[
                        const SizedBox(width: 4),
                        Text(
                          browserProvider.isSecureSite ? "Safe" : "Not Safe",
                          style: TextStyle(
                            color: browserProvider.isSecureSite ? Colors.blue : Colors.red,
                            fontSize: 10,
                  ...
                  suffixIcon: browserProvider.isLoading
                    ...
                    : IconButton(
                        icon: const Icon(Icons.refresh_rounded, color: CuteColors.lightText),
                ...
                style: const TextStyle(color: CuteColors.darkText, fontSize: 16),
              ),
            ),
          ),
          const SizedBox(width: 12),
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Icon(icon, color: Provider.of<BrowserProvider>(context).adaptiveTextColor, size: 24),
        ),
      ),
    );
  }
